...
const AdminRegisterPage = () => {
  ...
  const [isDisplaySuccessMessage, setIsDisplaySuccessMessage] = useState<boolean>(false);
    ...
    <div className="w-full h-screen flex flex-col items-center justify-center p-8 bg-blue-200">
      <div className="w-2/3 flex flex-col items-center">
        ...
        {isDisplaySuccessMessage && (
          <div className="mb-8 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative flex" role="alert">
        ...
        <div className="bg-sky-400 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col items-center">
          <h3 className="text-gray-700 text-2xl mb-4">เข้าสู่ระบบสร้าง Username ผู้ป่วย</h3>
          <div className="mb-4">
            <Input
              placeholder="HN"
              value={HN}
